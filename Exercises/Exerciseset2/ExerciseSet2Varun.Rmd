...
A1. 6 components
<br>
A2. 5 Year, 10 Year TNotes and Treasury Bonds
<br>
A3. These are the Principal Component Factors
<br>
A4.
<br>
(a) Pre-Crisis Years:
...
show_data2 = data.frame(cbind(colnames(crisis_data), round(cor(crisis_data),2)))
m2<-gvisTable(show_data2,options=list(width=1920, height=min(400,27*(nrow(show_data2)+1)),allowHTML=TRUE))
print(m2,'chart')
...
m2<-gvisTable(show_data2,options=list(width=1920, height=min(400,27*(nrow(show_data2)+1)),allowHTML=TRUE,page='disable'),formats=list(Eigenvalue="#.##",Percentage_of_explained_variance="#.##",Cumulative_percentage_of_explained_variance="#.##"))
print(m2,'chart')
...
Rotated_Factors2 <- Rotated_Factors2[sorted_rows2,]
...
m2<-gvisTable(show_data2,options=list(showRowNumber=TRUE,width=1220, height=min(400,27*(nrow(show_data)+1)),allowHTML=TRUE,page='disable'))
print(m2,'chart')
```
